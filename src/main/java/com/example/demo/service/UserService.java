...
public class UserService extends BaseService{
    ...
    public DataTablesPage userListPage(DataTablesParam dataTablesParam, SysUser sysUser) {
        PageInfo<SysUser> list = PageHelper.startPage(dataTablesParam.getPageNum(),dataTablesParam.getLength()).doSelectPageInfo(()->userMapper.selectByExample(new SysUserExample()));
        return null;
    }
}
